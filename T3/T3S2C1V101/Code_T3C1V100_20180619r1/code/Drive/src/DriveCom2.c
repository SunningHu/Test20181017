...
void Cmd1110(void)
{
    ...
    g_ucUsart2Buf[0] = 0x01;
    g_ucUsart2Buf[1] = 0x11;
    g_ucUsart2Buf[2] = 0x0F;
    g_ucUsart2Buf[3] = 0xD5;
    g_ucUsart2Buf[4] = 0x9D;
    crc = crc16(g_ucUsart2Buf,5);
    g_ucUsart2Buf[5] = crc >> 8;
    g_ucUsart2Buf[6] = crc & 0x00ff;
}
...
void Cmd1111(void)
{
    ...
    g_ucUsart2Buf[0] = 0x01;
    g_ucUsart2Buf[1] = 0x11;
    g_ucUsart2Buf[2] = 0x0B;
    g_ucUsart2Buf[3] = 0xE8;
    g_ucUsart2Buf[4] = 0xBA;
    crc = crc16(g_ucUsart2Buf,5);
    g_ucUsart2Buf[5] = crc >> 8;
    g_ucUsart2Buf[6] = crc & 0x00ff;
}
...
void Cmd1112(void)
{
    ...
    g_ucUsart2Buf[0] = 0x01;
    g_ucUsart2Buf[1] = 0x11;
    g_ucUsart2Buf[2] = 0x0A;
    g_ucUsart2Buf[3] = 0xF8;
    g_ucUsart2Buf[4] = 0x3D;
    crc = crc16(g_ucUsart2Buf,5);
    g_ucUsart2Buf[5] = crc >> 8;
    g_ucUsart2Buf[6] = crc & 0x00ff;
}
...
void Cmd1113(void)
{
    ...
    g_ucUsart2Buf[0] = 0x01;
    g_ucUsart2Buf[1] = 0x11;
    g_ucUsart2Buf[2] = 0x0D;
    g_ucUsart2Buf[3] = 0x80;
    g_ucUsart2Buf[4] = 0xD9;
    crc = crc16(g_ucUsart2Buf,5);
    g_ucUsart2Buf[5] = crc >> 8;
    g_ucUsart2Buf[6] = crc & 0x00ff;
}
