...
void PCorrAOutUp(void)
{
    ...
    for(i = 1; i < READ_MAXTIME; i++)
    {
        ...
        if((s32data[i] - s32data[i-1]) <= 4 && (s32data[i] - s32data[i-1]) >= -4)
        {  
            if(s32data[i] >= 19000 && s32data[i] <= 21000)
            {
                j++; 
            }
            else
...
void CorrVOut20Down(void)
{
    ...
    for(i = 1; i < READ_MAXTIME; i++)
    {
        ...
        if((s32data[i] - s32data[i-1]) <= 4 && (s32data[i] - s32data[i-1]) >= -4)
        {
            if(s32data[i] >= 400 && s32data[i] <= 550)
            {
                j++; 
            }
            else
...
void CorrVOut100Up(void)
{
    ...
    for(i = 1; i < READ_MAXTIME; i++)
    {
        ...
        if((s32data[i] - s32data[i-1]) <= 4 && (s32data[i] - s32data[i-1]) >= -4)
        {
            if(s32data[i] >= 9750 && s32data[i] <= 10050)
            {
                j++;  
            }
            else
...
void CorrROut3100(void)
{
    ...
    Usart3_SendCmd_Test(16);//进入S3远程
    Usart3_SendCmd_Test(3);//设置S3输出mA
    Usart3_SendCmd_Test(5);//设置S3输出3mA
    Usart3_SendCmd_Test(3);//设置S3输出mA
    Usart3_SendCmd_Test(5);//设置S3输出3mA
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(21);//设置S3测量mV         
    Usart2_SendCmd(15);//R 3mA 100    
    msdelay(400);
    Usart3_SendCmd_Test(0);//读取校验仪测量值
    s32data[0] = value.s32TestROut[0];
    value.g_fMacData = S32tofloat(s32data[0]);
    for(i = 1; i < READ_MAXTIME; i++)
    {
        ...
        s32data[i] = value.s32TestROut[0];
        value.g_fMacData = S32tofloat(s32data[i]);
        if((s32data[i] - s32data[i-1]) <= 5 && (s32data[i] - s32data[i-1]) >= -5)
        {
            if(s32data[i] >= 25000 && s32data[i] <= 40000)
            {
                j++; 
            }
            else
...
void CorrROut1300(void)
{
    ...
    Usart3_SendCmd_Test(16);//进入S3远程
    Usart3_SendCmd_Test(3);//设置S3输出mA
    Usart3_SendCmd_Test(9);//设置S3输出1mA
    Usart3_SendCmd_Test(3);//设置S3输出mA
    Usart3_SendCmd_Test(9);//设置S3输出1mA
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(21);//设置S3测量mV         
    Usart2_SendCmd(16);//R 1mA 300    
    msdelay(400);
    Usart3_SendCmd_Test(0);//读取校验仪测量值
    s32data[0] = value.s32TestROut[1];
    value.g_fMacData = S32tofloat(s32data[0]);
...
void CorrROut1100(void)
{
    ...
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(21);//设置S3测量mV         
    Usart2_SendCmd(17);//R 1mA 300    
    msdelay(400);
    Usart3_SendCmd_Test(0);//读取校验仪测量值
    s32data[0] = value.s32TestROut[2];
    value.g_fMacData = S32tofloat(s32data[0]);
    for(i = 1; i < READ_MAXTIME; i++)
    {
        Usart2_SendCmd(17);//V下限输出读
        Usart2_SendCmd(17);//V下限输出读
        Usart2_SendCmd(17);//V下限输出读        
        msdelay(200);
        Usart3_SendCmd_Test(0);//读取校验仪测量值
        s32data[i] = value.s32TestROut[2];
        value.g_fMacData = S32tofloat(s32data[i]);
        if((s32data[i] - s32data[i-1]) <= 5 && (s32data[i] - s32data[i-1]) >= -5)
        {
            if(s32data[i] >= 5000 && s32data[i] <= 15000)
            {
                j++; 
            }
            else
    ...
    value.fCorrROut[2] =  S32tofloat(s32data[i]);
    if(j >= limit.u16MaxOKCount)
    {
        Cmd12Send(value.fCorrROut[2]);     //S2输出标定写并发送命令 
        msdelay(400);
        flag.u8count++;
        if(flag.u8count >= 5)
        {
...
void CorrROut5300(void)
{
    ...
    Usart3_SendCmd_Test(16);//进入S3远程
    Usart3_SendCmd_Test(3);//设置S3输出mA
    Usart3_SendCmd_Test(13);//设置S3输出0.5mA
    Usart3_SendCmd_Test(3);//设置S3输出mA
    Usart3_SendCmd_Test(13);//设置S3输出0.5mA
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(21);//设置S3测量mV         
    Usart2_SendCmd(18);//R 1mA 300    
    msdelay(400);
    Usart3_SendCmd_Test(0);//读取校验仪测量值
    s32data[0] = value.s32TestROut[3];
    value.g_fMacData = S32tofloat(s32data[0]);
    for(i = 1; i < READ_MAXTIME; i++)
    {
        Usart2_SendCmd(18);//V下限输出读
        Usart2_SendCmd(18);//V下限输出读
        Usart2_SendCmd(18);//V下限输出读        
        msdelay(200);
        Usart3_SendCmd_Test(0);//读取校验仪测量值
        s32data[i] = value.s32TestROut[3];
        value.g_fMacData = S32tofloat(s32data[i]);
        if((s32data[i] - s32data[i-1]) <= 5 && (s32data[i] - s32data[i-1]) >= -5)
        {
            if(s32data[i] >= 10000 && s32data[i] <= 20000)
            {
                j++; 
            }
            else
    ...
    value.fCorrROut[3] =  S32tofloat(s32data[i]);
    if(j >= limit.u16MaxOKCount)
    {
        Cmd12Send(value.fCorrROut[3]);     //S2输出标定写并发送命令 
        msdelay(400);
        flag.u8count++;
        if(flag.u8count >= 5)
        {
...
void CorrROut5100(void)
{
    ...
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(21);//设置S3测量mV         
    Usart2_SendCmd(19);//R 1mA 300    
    msdelay(400);
    Usart3_SendCmd_Test(0);//读取校验仪测量值
    s32data[0] = value.s32TestROut[4];
    value.g_fMacData = S32tofloat(s32data[0]);
    for(i = 1; i < READ_MAXTIME; i++)
    {
        Usart2_SendCmd(19);//V下限输出读
        Usart2_SendCmd(19);//V下限输出读
        Usart2_SendCmd(19);//V下限输出读        
        msdelay(200);
        Usart3_SendCmd_Test(0);//读取校验仪测量值
        s32data[i] = value.s32TestROut[4];
        value.g_fMacData = S32tofloat(s32data[i]);
        if((s32data[i] - s32data[i-1]) <= 5 && (s32data[i] - s32data[i-1]) >= -5)
        {
            if(s32data[i] >= 0 && s32data[i] <= 11000)
            {
                j++; 
            }
            else
    ...
    value.fCorrROut[4] =  S32tofloat(s32data[i]);
    if(j >= limit.u16MaxOKCount)
    {
        Cmd12Send(value.fCorrROut[4]);     //S2输出标定写并发送命令 
        msdelay(400);
        flag.u8count++;
        if(flag.u8count >= 5)
        {
...
void CorrROut2100(void)
{
    ...
    Usart3_SendCmd_Test(16);//进入S3远程
    Usart3_SendCmd_Test(3);//设置S3输出mA
    Usart3_SendCmd_Test(7);//设置S3输出0.5mA
    Usart3_SendCmd_Test(3);//设置S3输出mA
    Usart3_SendCmd_Test(7);//设置S3输出0.5mA
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(18);//打开输出   
    Usart3_SendCmd_Test(21);//设置S3测量mV         
    Usart2_SendCmd(20);//R 0.2mA 100    
    msdelay(400);
    Usart3_SendCmd_Test(0);//读取校验仪测量值
    s32data[0] = value.s32TestROut[5];
    value.g_fMacData = S32tofloat(s32data[0]);
    for(i = 1; i < READ_MAXTIME; i++)
    {
        Usart2_SendCmd(20);//V下限输出读
        Usart2_SendCmd(20);//V下限输出读
        Usart2_SendCmd(20);//V下限输出读        
        msdelay(200);
        Usart3_SendCmd_Test(0);//读取校验仪测量值
        s32data[i] = value.s32TestROut[5];
        value.g_fMacData = S32tofloat(s32data[i]);
        if((s32data[i] - s32data[i-1]) <= 5 && (s32data[i] - s32data[i-1]) >= -5)
        {
            if(s32data[i] >= 0 && s32data[i] <= 10000)
            {
                j++; 
            }
            else
    ...
    value.fCorrROut[5] =  S32tofloat(s32data[i]);
    if(j >= limit.u16MaxOKCount)
    {
        Cmd12Send(value.fCorrROut[5]);     //S2输出标定写并发送命令 
        msdelay(400);
        flag.u8count++;
        if(flag.u8count >= 5)
        {
...
void CorrAInUp(void)
{
    ...
    for(i = 1; i < READ_MAXTIME; i++)
    {
        ...
        if((s16data[i] - s16data[i-1]) <= 4 && (s16data[i] - s16data[i-1]) >= -4)
        {
            if(s16data[i] >= 3350 && s16data[i] <= 3550)
            {
                j++;
            }
            else
