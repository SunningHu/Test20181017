...
//背光控制
#define		LCD_BRIGHT_PORT			    GPIOD
#define		LCD_BRIGHT_PIN				GPIO_Pin_4

//SLAVE ADDRESS
#define     HT16C23_READ                0x7B
#define     HT16C23_WRITE               0x7A

//最大RAM地址
#define     MAXRAM_4DUTY                0x23
#define     MAXRAM_8DUTY                0x43
#define     MAXRAM_16DUTY               0x76
...
#define     DUTY4BIAS5                  0x04                //1/4 duty 1/5 bias
#define     DUTY8BIAS3                  0x02                //1/8 duty 1/3 bias
#define     DUTY8BIAS4                  0x03                //1/8 duty 1/4 bias
#define     DUTY8BIAS5                  0x06                //1/8 duty 1/5 bias
#define     DUTY16BIAS3                 0x08                //1/16 duty 1/3 bias
#define     DUTY16BIAS4                 0x09                //1/16 duty 1/4 bias
#define     DUTY16BIAS5                 0x0C                //1/16 duty 1/5 bias
...
{    
    ...
    memset(LCD_Buf, 0xFF, sizeof(LCD_Buf));                 //全显示
    ...
    HT16C23_WriteRAM(0x00, LCD_Buf, sizeof(LCD_Buf));       //写RAM数据,全点量
