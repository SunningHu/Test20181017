...
s32  fPeriodArray[30] = {0};
u8 fPeriodNum = 0;

extern u8 adc_int_flag;

/****************调试信息*******************************/
//extern void    DAC8811_Write(u16 u16Data);
...
INTERRUPT_HANDLER(USART1_RX_TIM5_CC_IRQHandler, 28)
{
 ...
 u8 hzFlag = 0;
  data.u8Hzfalg = 1;
   if((TIM5_GetITStatus(TIM5_IT_CC2)) != RESET)
    {
      hzFlag = 1;
       switch(temp)
       {
       case 0:
           ICValue1=TIM5_GetCapture2();
           fnum = 0;
           temp=1;
           break;
       case 1:
           ICValue2=TIM5_GetCapture2();
           temp=2;
           break;
       default:
           break;
    ...
    if(temp == 2)
    {
      if(fnum == 0)     
         ...
         Period =  65535 * fnum + ICValue2 - ICValue1;
     if(data.u8MFlagHz == 0)
     {
       fPeriodArray[fPeriodNum] =  Period;
       fPeriodNum++;
       if(fPeriodNum > 29)
         fPeriodNum = 0;
     }
